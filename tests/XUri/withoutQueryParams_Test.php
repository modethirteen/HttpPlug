...
class withoutQueryParams_Test extends PlugTestCase {

    /**
     * @test
     */
    public function Can_remove_query_parameters() : void {
     ...
     * @test
     */
    public function Can_remove_query_parameters_if_no_query_parameters_exist() : void {
